(function (c) {
    ...
    a.define('/gif.coffee', function (d, m, l, k) {
        ...
        function j(d, b) {
            for (var a = 0, c = b.length; a < c; ++a) if (a in b && b[a] === d) {
                return !0;
            }
            return !1;
        }
        ...
        f = a('events', d).EventEmitter, h = a('/browser.coffee', d), e = function (d) {
            ...
            return i(a, d), c = {
                ...
                height: null,
                transparent: null,
            }, b = { delay: 500, copy: !1 }, a.prototype.setOption = function (a, b) {
                ...
                var a;
                while (!0) {
                    if (a = this.activeWorkers.shift(), !(null != a)) {
                        break;
                    }
        ...
        c = navigator.userAgent.toLowerCase(), e = navigator.platform.toLowerCase(), b = c.match(/(opera|ie|firefox|chrome|version)[\s\/:]([\w\d\.]+)?.*?(safari|version[\s\/:]([\w\d\.]+)|$)/) || [null, 'unknown', 0], d = b[1] === 'ie' && document.documentMode, a = {
            ...
            platform: { name: c.match(/ip(?:ad|od|hone)/) ? 'ios' : (c.match(/(?:webos|android)/) || e.match(/mac|win|linux/) || ['other'])[0] },
        ...
        a.prototype.setMaxListeners = function (a) {
            ...
            if (!(typeof a == 'function')) {
                if (c(a)) {
                    var b = Array.prototype.slice.call(arguments, 1), e = a.slice();
